...
export function TextButton(props: ButtonProps) {
	return (
		<button {...props} className={c(styles.text__button, props.className)}
		>{props.text}
		</button>
	)
}
...
export function SubmitButton(props: { className?: string, loading: boolean, arrow?: boolean, label?:string }) {
	return (
