...
export function SubmitButton(props: {className?: string, loading: boolean}) {
    return (
        <div className={props.className}>
            <button className={styles.submit__button} type='submit' disabled={props.loading} >Submit<svg width="19" height="10" viewBox="0 0 19 10" fill="none" xmlns="http://www.w3.org/2000/svg">
